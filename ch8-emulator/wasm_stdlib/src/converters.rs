...
pub fn convert_u32_to_str(mut number: u32) -> [u8; 10] {
    ...
    if number > 999_999_999 {
        ...
        number -= 1_000_000_000 * result[pos] as u32;
    ...
    if number > 99_999_999 {
        ...
        number -= 100_000_000 * result[pos] as u32;
    ...
    if number > 9_999_999 {
        ...
        number -= 10_000_000 * result[pos] as u32;
    ...
    if number > 999_999 {
        ...
        number -= 1_000_000 * result[pos] as u32;
    ...
    if number > 99_999 {
        ...
        number -= 100_000 * result[pos] as u32;
    ...
    if number > 9_999 {
        ...
        number -= 10_000 * result[pos] as u32;
    ...
    if number > 999 {
        ...
        number -= 1_000 * result[pos] as u32;
    ...
    //* units
    if number > 0 {
        result[pos] = number as u8;
        number -= result[pos] as u32;
